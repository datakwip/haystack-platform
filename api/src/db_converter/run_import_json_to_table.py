...
import db_converter.import_json_to_table as importer
...
def main():
    ...
    importerService = importer.ImportJson(config)
    #importerService.importIntoTable()
    importerService.importSites()
